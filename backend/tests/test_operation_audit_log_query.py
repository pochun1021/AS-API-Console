...
def test_operation_audit_logs_default_hot_window_and_filters(client, admin_headers):
    now = datetime.now(UTC)
    _insert_log(now - timedelta(days=2), "api_key", "success")
    ...
    assert filtered_body["items"][0]["event_type"] == "whitelist"
