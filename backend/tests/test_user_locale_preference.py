...
def test_get_locale_preference_defaults_to_null(client):
    ...
    resp = client.get(api_path("/users/preferences/locale"), headers=user_headers)
...
def test_update_and_get_locale_preference(client):
    ...
    update_resp = client.patch(
        api_path("/users/preferences/locale"),
    ...
    get_resp = client.get(api_path("/users/preferences/locale"), headers=user_headers)
...
def test_locale_preferences_are_isolated_by_sysid(client):
    ...
    client.patch(api_path("/users/preferences/locale"), headers=user_1_headers, json={"preferred_locale": "en"})
    client.patch(api_path("/users/preferences/locale"), headers=user_2_headers, json={"preferred_locale": "zh-TW"})

    user_1 = client.get(api_path("/users/preferences/locale"), headers=user_1_headers)
    user_2 = client.get(api_path("/users/preferences/locale"), headers=user_2_headers)
