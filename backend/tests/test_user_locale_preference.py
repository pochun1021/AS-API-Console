...
def test_locale_preferences_are_isolated_by_sysid(client):
    user_1_headers = build_headers(role="user", account="u1", email="u1@example.com", sysid="loc-user-1")
    user_2_headers = build_headers(role="user", account="u2", email="u2@example.com", sysid="loc-user-2")
