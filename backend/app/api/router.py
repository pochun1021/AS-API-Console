...
from app.api.v1 import announcements, api_keys, auth_audit_logs, institutes, models, operation_audit_logs, scheduler_logs, users, whitelists
...
api_router.include_router(scheduler_logs.router, tags=["scheduler-logs"])
api_router.include_router(whitelists.router, tags=["whitelists"])
api_router.include_router(users.router, tags=["users"])
api_router.include_router(institutes.router, tags=["institutes"])
