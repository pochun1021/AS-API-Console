...
test("formats UTC timestamp as Asia/Taipei date only", () => {
  expect(formatDateInTaipei("2026-03-10T23:30:00.000Z")).toBe("2026-03-11");
});
...
test("returns fallback for invalid datetime values", () => {
  ...
  expect(formatDateInTaipei("not-a-date")).toBe("-");
});
