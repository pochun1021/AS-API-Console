 ...
 * @typedef {{ id: string, status: 'active'|'revoked'|'expired', masked_key: string, key_alias: string, application_date: string, duration_months: number, expires_at: string, expiration_notice_sent_at?: string|null, extend_eligible?: boolean, owner_account?: string, owner_name?: string }} ApiKeyListItem
