 ...
 * @typedef {{ id: string, status: 'active'|'revoked'|'expired', masked_key: string, application_date: string, duration_months: number, expires_at: string, owner_account?: string, owner_name?: string }} ApiKeyListItem
